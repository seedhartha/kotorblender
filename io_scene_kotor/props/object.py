...
class ObjectPropertyGroup(bpy.types.PropertyGroup):
    ...
    birthrate: bpy.props.FloatProperty(name="Birthrate", default=10.0, min=-90.0, max=400.0)
    bounce_co: bpy.props.FloatProperty(name="Bounce Coefficient", min=0.0, max=1.0)
    combinetime: bpy.props.FloatProperty(name="Combine Time", min=0.0, max=3.0)
    drag: bpy.props.FloatProperty(name="Drag", description="Drag (m/s²)", min=0.0, max=1.0)
    fps: bpy.props.FloatProperty(name="FPS", description="Frames Per Second", default=24.0, min=0.0, max=60.0)
    frameend: bpy.props.FloatProperty(name="End Frame", min=0.0, max=255.0)
    framestart: bpy.props.FloatProperty(name="Start Frame", min=0.0, max=255.0)
    grav: bpy.props.FloatProperty(name="Gravity", description="Gravity (m/s²)", min=0.0, max=10.0)
    lifeexp: bpy.props.FloatProperty(name="Life Expectancy", default=1.0, min=-1.0, max=92.0)
    mass: bpy.props.FloatProperty(name="Mass", default=1.0, min=-0.5, max=9.0)
    p2p_bezier2: bpy.props.FloatProperty(name="Bezier 2", min=0.0, max=0.2)
    p2p_bezier3: bpy.props.FloatProperty(name="Bezier 3", min=0.0, max=3.0)
    particlerot: bpy.props.FloatProperty(name="Particle Rotation", min=-5.0, max=720.0)
    randvel:  bpy.props.FloatProperty(name="Random Velocity", min=0.0, max=20.0)
    sizestart: bpy.props.FloatProperty(name="Size Start", default=1.0, min=0.0, max=255.0)
    sizeend: bpy.props.FloatProperty(name="Size End", default=1.0, min=0.0, max=255.0)
    sizestart_y: bpy.props.FloatProperty(name="Y Size Start", min=0.0, max=40.0)
    sizeend_y: bpy.props.FloatProperty(name="Y Size End", min=0.0, max=60.0)
    spread: bpy.props.FloatProperty(name="Spread", min=0.0, max=360.0)
    threshold: bpy.props.FloatProperty(name="Threshold", min=0.0, max=1.0)
    velocity:  bpy.props.FloatProperty(name="Velocity", min=-2.0, max=200.0)
    xsize: bpy.props.FloatProperty(name="Size X", min=0.0, max=10000.0)
    ysize: bpy.props.FloatProperty(name="Size Y", min=0.0, max=10000.0)
    blurlength: bpy.props.FloatProperty(name="Blur Length", default=10.0, min=0.0, max=10.0)
    lightningdelay: bpy.props.FloatProperty(name="Lightning Delay", description="Lighting delay (seconds)", min=0.0, max=0.15)
    lightningradius: bpy.props.FloatProperty(name="Lightning Radius", description="Lighting radius (meters)", min=0.0, max=0.5)
    lightningsubdiv: bpy.props.FloatProperty(name="Lightning Subdivisions", min=0.0, max=10.0)
    lightningscale: bpy.props.FloatProperty(name="Lightning Scale", default=1.0, min=0.0, max=1.0)
    lightningzigzag: bpy.props.FloatProperty(name="Lightning Zig-Zag", min=0.0, max=25)
    alphamid: bpy.props.FloatProperty(name="Alpha Mid", default=1.0, min=-100.0, max=100.0)
    ...
    sizemid: bpy.props.FloatProperty(name="sizeMid", default=1.0, min=0.0, max=255.0)
    sizemid_y: bpy.props.FloatProperty(name="sizeMid_y", min=0.0, max=50.0)
    randombirthrate: bpy.props.FloatProperty(name="Random Birthrate", default=10.0, min=-40.0, max=100.0)
    targetsize: bpy.props.FloatProperty(name="Target Size", default=1.0, min=0.0, max=2.0)
    numcontrolpts: bpy.props.FloatProperty(name="Number of Control Points", min=0.0, max=1.0)
    controlptradius: bpy.props.FloatProperty(name="Control Point Radius", min=0.0, max=2.0)
    controlptdelay: bpy.props.FloatProperty(name="Control Point Delay", min=0.0, max=22.0)
    tangentspread: bpy.props.FloatProperty(name="Tangent Spread", description="Tangent spread (degrees)", min=0.0, max=45.0)
    tangentlength: bpy.props.FloatProperty(name="Tangent Length", min=0.0, max=2.0)
