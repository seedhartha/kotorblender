...
class ObjectPropertyGroup(bpy.types.PropertyGroup):
    ...
    birthrate: bpy.props.FloatProperty(name="Birthrate", default=10.0, soft_min=-90.0, soft_max=400.0)
    ...
    fps: bpy.props.FloatProperty(name="FPS", description="Frames Per Second", default=24.0, min=0.0, soft_max=60.0)
    ...
    grav: bpy.props.FloatProperty(name="Gravity", description="Gravity (m/s²)", min=0.0, soft_max=10.0)
    lifeexp: bpy.props.FloatProperty(name="Life Expectancy", default=1.0, soft_min=-1.0, soft_max=92.0)
    ...
    lightningdelay: bpy.props.FloatProperty(name="Lightning Delay", description="Lighting delay (seconds)", min=0.0, soft_max=0.15)
    lightningradius: bpy.props.FloatProperty(name="Lightning Radius", description="Lighting radius (meters)", min=0.0, soft_max=0.5)
    ...
    alphamid: bpy.props.FloatProperty(name="Alpha Mid", default=1.0, soft_min=-100.0, soft_max=100.0)
    ...
    randombirthrate: bpy.props.FloatProperty(name="Random Birthrate", default=10.0, soft_min=-40.0, soft_max=100.0)
    ...
    tangentspread: bpy.props.FloatProperty(name="Tangent Spread", description="Tangent spread (degrees)", min=0.0, soft_max=45.0)
